...
public class MainActivityV16 extends Activity {
    ...
    private final BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
        ...
        @Override public void onServicesDiscovered(BluetoothGatt current, int status) {
            ...
            enableNotify();
            setStatus(nusRx != null && nusTx != null ? "G28 pronto | Nordic UART ativo" : "Nordic UART incompleto");
            updateUi();
        }
    ...
    private void enableNotify() {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 33) {
                append("writeDescriptor result=" + gatt.writeDescriptor(descriptor, value));
            } else {
